Dada una secuencia de [[VariableAleatoria|variables aleatorias]] independientes $X_1, X_2, \ldots, X_n$ tal que comparten el mismo [[ValorEsperado|valor esperado]] $E(X_i) = \mu$, y la misma [[Varianza_DesviacionEstandar|varianza]] $\text{Var}(X_i) = \sigma^2$. Entonces la media de las muestras converge a $\mu$ cuando $n \to \infty$:
...
Entonces, por la [[DesigualdadChabyshev|desigualdad de Chabyshev]]:
...
#probability #calculus #mean #variance #theorem 