[[VariableAleatoriaBernoulliBinomial|Variables aleatorias Bernoulli y Binomial]]:
1. Bernoulli: Una [[VariableAleatoria|variable aleatoria]] se dice es Bernoulli, si únicamente puede tomar dos valores, 0 para fracasos, y 1 para éxitos.
...
[[DistribucionNormal|Distribución Normal]]:
...
[[DistribucionPoisson|Distribución Poisson]]:
...
[[DistribucionGeometrica|Distribución Geométrica]]:
...
[[DistribucionExponencial|Distribución Exponencial]]:
...
$$
[[DistribucionGamma|Distribución Gamma]]:

[[DistribucionChi-Cuadrada|Distribución Chi-Cuadrada]]:

[[DistribucionesMarginalCondicional|Distribuciones Marginal y Condicional]]:
