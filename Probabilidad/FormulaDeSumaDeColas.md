Sea $X$ una [[VariableAleatoria|variable aleatoria]] no negativa. Entonces del [[ValorEsperado|valor esperado]] se puede escribir como:
...
(Recordar que $P(X \geq k) = 1 - P(X \leq k)$, donde $P(X\leq k)$ es la *CDF*.)
